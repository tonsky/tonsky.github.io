...
<p class="slide" style="background: url(platforms.png); background-size: 100%"></p>
...
<p class="slide" style="background: url(functional-programming.png); background-size: 100%"></p>
...
<p class="slide" style="background: url(structural-sharing.png); background-size: 100%"></p>
...
<p class="slide" style="background: url(dom.png); background-size: 100%"></p>

Давайте представим, что DOM-дерево неизменяемо. Тогда все переходы между состояниями можно выразить чистыми функциями:

<p class="slide" style="background: url(doms.png); background-size: 100%"></p>
...
<p class="slide" style="background: url(dom-models.png); background-size: 100%"></p>
