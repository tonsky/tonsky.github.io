...
<figure><img src="./cover.png" height="331"></figure>

I’m not an expert in hiring for big companies, but I have extensive experience for small ones and a bit of common sense.

Back in 2013, I run a highly successful hiring campaign for [AboutEcho.com](https://web.archive.org/web/20140101000655/http://aboutecho.com/) that led to the hiring of nine senior-level engineers. My Russian-speaking readers could [read about it here](https://tonsky.livejournal.com/288899.html).

All that gives me the confidence to critisize practices Internet Giants use to hire engineers to this day.
...
This is expected, given that they only have 45 minutes and there are lots of things they want to go through with you.

What I can’t understand is that you’re judged by the quality of the solution you came up with in two minutes.

This is really strange, given how human creativity works. It’s not hard to come up with ideas, but even in a most brilliant brain nobody guarantees the first one will be the best one. Even the geniuses can’t predictable generate world-best answers on a clock.
...
Off-by-one errors are widely-accepted as one of the hardest problems in CS for a reason—everyone makes them. Errors are part of programmer’s life, not something you can get rid of. Good programmer simply knows what to do about it. Quality of a programmes is NOT defined by how few errors she makes. 
