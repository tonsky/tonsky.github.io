...
ClojureCup is a contest, so if you love the idea and want to support the project, <a href="https://clojurecup.com/#/apps/acha" style="color: hsl(45,98%,73%); border-color: hsl(45,98%,77%);">vote for us</a>.
